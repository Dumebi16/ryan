        ...
        <div className="flex flex-col lg:flex-row min-h-[72vh]">
          ...
          <div className="flex-1 flex flex-col justify-between px-8 sm:px-12 lg:px-16 xl:px-20 py-12 lg:py-14 border-t lg:border-t-0 lg:border-l border-white/[0.08]">
            ...
            <div className="flex-1 flex flex-col justify-center py-12 lg:py-0 max-w-lg">
              ...
              <motion.div initial={{ opacity: 0, y: 8 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.2 }} viewport={{ once: true, amount: 0.3 }}><button className="font-kiona text-[11px] border border-white/20 text-white px-10 py-4 hover:bg-white hover:text-black hover:border-white transition-all duration-300 inline-flex items-center gap-3">LEARN MORE ABOUT RYAN <ArrowRight size={12} strokeWidth={1.5} /></button></motion.div>
            </div>
      ...
      <section id="services" className="relative z-10 bg-[#F5F5F0] py-20 md:py-28 px-6 sm:px-10 md:px-16 lg:px-24" style={{ backgroundImage: "radial-gradient(ellipse 65% 55% at 22% 65%, rgba(212,175,55,0.11) 0%, transparent 60%), radial-gradient(ellipse 55% 45% at 78% 35%, rgba(212,175,55,0.07) 0%, transparent 60%)" }}>
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6">
            {[ { title: "SBA Loans", tag: "SBA 7(a) & 504", description: "Funding solutions for acquisitions, expansion, partner buyouts, equipment, and working capital.", Icon: SBALoansIcon }, { title: "Business Acquisition", tag: "Buy-Side Advisory", description: "Guidance for buyers navigating valuation, structure, lender expectations, and the financing process.", Icon: AcquisitionIcon }, { title: "Strategic Financial Guidance", tag: "Deal Strategy", description: "Clarity around loan readiness, financial positioning, and the decisions that shape a stronger funding outcome.", Icon: GuidanceIcon } ].map(({ title, tag, description, Icon }, i) => (
          ...
          <motion.div initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2 }} viewport={{ once: true }} className="mt-12 md:mt-14"><button className="font-kiona text-[11px] border border-black/20 text-black px-10 py-4 hover:bg-black hover:text-white hover:border-black transition-all duration-300 flex items-center gap-3">VIEW ALL SERVICES <ArrowRight size={12} strokeWidth={1.5} /></button></motion.div>
        </div>
      </section>
