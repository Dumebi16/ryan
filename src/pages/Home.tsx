  ...
  return (
    <section className="relative bg-black overflow-hidden px-6 sm:px-10 py-28 md:py-40">
      ...
      <div className="relative z-10 max-w-2xl mx-auto text-center">
        ...
        <motion.div initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.55, delay: 0.24 }} viewport={{ once: true, amount: 0.4 }} className="flex flex-col sm:flex-row items-center justify-center gap-4"><button className="font-kiona text-[11px] bg-[#D4AF37] text-black px-10 py-4 hover:bg-white hover:text-black transition-colors duration-300 inline-flex items-center gap-3 w-full sm:w-auto justify-center">START YOUR APPLICATION <ArrowRight size={12} strokeWidth={1.5} /></button><button className="font-kiona text-[11px] border border-white/20 text-white px-10 py-4 hover:bg-white hover:text-black hover:border-white transition-all duration-300 inline-flex items-center gap-3 w-full sm:w-auto justify-center">BOOK A CALL</button></motion.div>
      </div>
    </section>
  );
};
